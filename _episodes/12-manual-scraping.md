...
Now we are finally ready to do some web scraping using Scraper Chrome Extension. Please refer to the <a href="https://librarycarpentry.org/lc-webscraping/setup" target="_blank"> Setup instructions /</a>.
